...
//	private static ArrayList<String> idTickDatastr=new ArrayList<String>();
//	private static ArrayList<ArrayList<Double>> idTickDatadta=new ArrayList<ArrayList<Double>>();
//	
//	private static ArrayList<String> topIdTickDatastr=new ArrayList<String>();
//	private static ArrayList<ArrayList<Double>> topIdTickDatadta=new ArrayList<ArrayList<Double>>();
//	
...
//	System.out.println(msg.getElement("securities"));
...
//	 System.out.println(fieldDataArray.numValues());
//	 Date[] dates = new Date[fieldDataArray.numValues()];
...
//	 Double[] oCValues = new Double[3];
//	 for (int k = 0; k < fieldData.numElements(); ++k) {
//	 Element field = fieldData.getElement(k);
//	 if(k==1){
//		 oCValues[0] = Double.parseDouble(field.getValueAsString());
//	 }
//	 else if (k==2){
//		 oCValues[1] = Double.parseDouble(field.getValueAsString());
//	 }
////	 Element sec = securityData.getElement(k);System.out.println(sec.getValueAsString());
...
//	 }
	 ...
	 prevClosing=closVal;
	 previousFlag = flag;
//	 arrayList.add(oCValues);
	 }
//	 System.out.println(arrayList.get(0)[0]+" "+arrayList.get(0)[1]+" "+arrayList.get(0)[2]);
	 
//	 StateMatrix(arrayList);
	 ...
	 //and here is you expected earning per dollar ...enjoy :)
	 Double expectedProfit=expextedValue(movngAvg,averageProb);
//	 long v = (long)(expectedProfit*1000000000);
	 ...
	 //build id-tickvalue map
	 idTickData.put(equityName, idtick);
//	 idTickDatastr.add(equityName);
//	 idTickDatadta.add(idtick);
...
//				 topIdTickDatastr.add(key);
//				 topIdTickDatadta.add(idTickData.get(key));
			 }else{
